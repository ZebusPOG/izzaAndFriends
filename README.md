...
Website untuk mendukung pertumbuhan ekonomi lokal melalui promosi digital Usaha Mikro, Kecil, dan Menengah (UMKM). Dibangun sebagai proyek mata kuliah Pemrograman Web menggunakan Laravel 13.
...
| No | Nama   | NPM    |       Role                  |
|----|--------|--------|-----------------------------|
| 1  | Justin | 250004 | Backend & Database          |
| 2  | Izza   | 250100 | Frontend & UI/UX            |
| 3  | Danias | 250058 | Admin Dashboard & Integrasi |
